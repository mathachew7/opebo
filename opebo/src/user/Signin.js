      ...
      <div className='max-w-md w-full'>
        ...
        <form className='mt-8' action='#' method='POST'>
          ...
          <div className='mt-6'>
            ...
            <div className='text-sm leading-5 mt-5 text-center'>
              <div className='mb-5 text-sm leading-5'>
                <Link
                  to='/vendor/signin'
                  className='text-xs text-gray-900 hover:text-indigo-500 focus:outline-none focus:underline transition ease-in-out duration-150'
                >
                  Are you a vendor?{" "}
                  <span className='text-md font-bold'>Go to vendor SignIn</span>
                </Link>
              </div>
              <Link
                to='/'

      ...
      <div className='flex flex-col justify-center p-10 font-sans md:px-32'>
        ...
        <div className='mt-8 justify-center md:text-justify items-center'>
          <h1 className='font-bold text-4xl'>
            Privacy Policy for{" "}
            <span className='text-orange-500'>Opebo Industries Ltd.</span>
          </h1>
          ...
          <h2 className='mt-10 font-bold text-3xl'>Consent</h2>
          ...
          <h2 className='mt-10 font-bold text-3xl'>Information we collect</h2>
          ...
          <h2 className='mt-10 font-bold text-3xl'>Log Files</h2>
          ...
          <h2 className='mt-10 font-bold text-3xl'>Cookies and Web Beacons</h2>
          ...
          <h2 className='mt-10 font-bold text-3xl'>Our Advertising Partners</h2>
          ...
          <h2 className='mt-10 font-bold text-3xl'>Children's Information</h2>

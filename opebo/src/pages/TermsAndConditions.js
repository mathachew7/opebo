...
function TermsAndConditions() {
  return (
    <>
      <div className='flex flex-col justify-center p-10 font-sans md:px-32'>
        ...
        <div className='mt-8 justify-center items-center'>
          ...
          <p className='font-medium text-xl text-orange-500'>
            Welcome to opeboindustries.com!
          </p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of{" "}
            <span className='font-bold text-md'>Opebo Industries Ltd.'s</span>{" "}
            Website, located at{" "}
            <Link
              to='/'
              key='Home'
          ...
          <p>
            ...
            conditions. Do not continue to use opeboindustries.com if you do not
          ...
          <p>
            We employ the use of cookies. By accessing opeboindustries.com, you
            agreed to use cookies in agreement with the Opebo Industries Pvt.
          ...
          <p>
            Unless otherwise stated, Opebo Industries Ltd. and/or its licensors
            own the intellectual property rights for all material on
            opeboindustries.com. All intellectual property rights are reserved.
            You may access this from opeboindustries.com for your own personal
            use subjected to restrictions set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from opeboindustries.com</li>
            <li>Sell, rent or sub-license material from opeboindustries.com</li>
            <li>
              Reproduce, duplicate or copy material from opeboindustries.com
            </li>
            <li>Redistribute content from opeboindustries.com</li>
          </ul>
          ...
          <p>
            ...
            Opebo Industries Ltd. does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of Opebo Industries Ltd.,its agents
            ...
            applicable laws, Opebo Industries Ltd. shall not be liable for the
          ...
          <p>
            Opebo Industries Ltd. reserves the right to monitor all Comments and
          ...
          <p>
            You hereby grant Opebo Industries Ltd. a non-exclusive license to
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Opebo
            Industries Ltd.; and (d) the link is in the context of general
          ...
          <p>
            ...
            sending an e-mail to Opebo Industries Ltd.. Please include your
          ...
          <p>
            No use of Opebo Industries Ltd.'s logo or other artwork will be
          ...
          <Link to='/disclaimer' key='Disclaimer' className='text-md font-bold'>
            read Disclaimer
          </Link>
